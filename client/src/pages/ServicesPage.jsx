  ...
  return (
    <div id={service.slug} data-cursor="hover" data-svc-item onMouseMove={handleMove} onMouseLeave={() => setTilt({x:0,y:0})}
      ...
      <div className="relative z-10">
        ...
        <Link to={`/services/${service.slug}`} className="inline-flex items-center gap-1.5 text-[13px] font-semibold transition-all duration-300 group-hover:gap-2" style={{ color: service.color, textDecoration: 'none' }}>
...
export default function ServicesPage() {
  ...
  return (
    <div ref={pageRef}>
      ...
      <div className="relative z-10">
        {/* Hero */}
        <section className="relative pt-8 sm:pt-10 pb-14">
          ...
          <Container>
            <div data-svc-banner className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 px-8 py-10 lg:px-14 lg:py-14 flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <Button variant="accent" size="lg" href="/booking">Start Consultation <ArrowRight className="w-4 h-4" /></Button>
              </div>
            </div>
          </Container>
        </section>
