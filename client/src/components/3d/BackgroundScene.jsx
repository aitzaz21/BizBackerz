  ...
  return (
    <group>
      ...
      <mesh ref={ring1Ref} rotation={[Math.PI * 0.5, 0, 0]}>
        <torusGeometry args={[2.92, 0.013, 6, 64]} />
      ...
      <mesh ref={ring2Ref} rotation={[0.55, 0.28, 0]}>
        <torusGeometry args={[3.35, 0.009, 6, 56]} />
      ...
      <mesh ref={ring3Ref} rotation={[Math.PI * 0.15, 0.5, 0.3]}>
        <torusGeometry args={[3.75, 0.007, 6, 48]} />
      ...
      <mesh ref={ring4Ref} rotation={[1.1, -0.3, 0.6]}>
        <torusGeometry args={[4.1, 0.005, 6, 40]} />
...
───────────────────────────────────────── */
const GalaxyDust = memo(function GalaxyDust({ count = 700 }) {
  const ref = useRef()
