...
import {
  ...
  ArrowRight, Trophy, Star, Shield, Zap,
} from 'lucide-react'
    ...
    <div ref={wrapperRef} style={{ position: 'relative' }}>
      ...
      >
        ...
        >
          ...
          <div data-svc-sub>
            <a href="/services" className="group" style={{ display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 9.5, fontFamily: '"Clash Display",sans-serif', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#2a8bff', textDecoration: 'none' }}>
              View All Services
